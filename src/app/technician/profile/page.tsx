...
export default function TechnicianProfilePage() {
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      displayNameForm.setValue('displayName', currentUser.displayName || '');
    }
  }, [currentUser, displayNameForm]);
  ...
  const handleUploadPhoto = async () => {
    ...
    try {
      ...
      setSelectedFile(null);
      const photoInput = document.getElementById('techProfilePhotoInput') as HTMLInputElement | null;
  ...
  if (!currentUser || userRole !== 'technician') {
    return (
      <div className="container mx-auto py-8 px-4 text-center">
        <p>Access denied. Please log in as a technician to view this page.</p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold text-foreground mb-8 flex items-center gap-2">
        <User className="h-8 w-8 text-primary" /> My Profile (Technician)
      </h1>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="shadow-md">
          ...
          <CardContent className="space-y-4">
            <div>
              <Label htmlFor="techProfilePhotoInput">Choose Photo</Label>
              <Input
                id="techProfilePhotoInput"
                type="file"
        ...
        <Card className="shadow-md">
          ...
          <CardContent>
            <form onSubmit={displayNameForm.handleSubmit(handleUpdateDisplayName)} className="space-y-4">
              <div>
                <Label htmlFor="techDisplayNameInput">New Display Name</Label>
                <Input
                  id="techDisplayNameInput"
        ...
        <Card className="shadow-md">
          ...
          <CardContent>
            <form onSubmit={passwordForm.handleSubmit(handleChangePassword)} className="space-y-4">
              <div>
                <Label htmlFor="techCurrentPasswordInput">Current Password</Label>
                <Input
                  id="techCurrentPasswordInput"
                  type="password"
              ...
              <div>
                <Label htmlFor="techNewPasswordInput">New Password</Label>
                <Input
                  id="techNewPasswordInput"
                  type="password"
              ...
              <div>
                <Label htmlFor="techConfirmNewPasswordInput">Confirm New Password</Label>
                <Input
                  id="techConfirmNewPasswordInput"
                  type="password"
